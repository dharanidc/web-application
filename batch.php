...
<div class="form-container">
   ...
   <form action="batchdetails.php" method="post" enctype="multipart/form-data">
...
http://localhost/musicon/landing/create.php
     ...
     echo '<a href="present.php?course='.$course.'" class="btn" style="background-color:#16a085;color:#fff;border-radius: 22px;
      margin-top: 26px;
      height: 43px;">'.$course.'</a>';
