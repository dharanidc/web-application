       ...
       <li class="nav-item">
        ...
        <div id="collapseBootstrapcon" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="ClassTeacher/viewAttendance.php">View Course Attendance</a>
            <a class="collapse-item" href="ClassTeacher/viewStudentAttendance.php">View Student Attendance</a>
