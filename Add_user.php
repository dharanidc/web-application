...
<form method="post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    <label for="exampleFormControlSelect1">Attendance</label>
    <select class="form-control" required name="attend" id="exampleFormControlSelect1">
