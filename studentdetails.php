...
http://localhost/musicon/landing/create.php
            ...
            //    echo  '<td>'.$no.'</td>';
                echo  '<td><a href="studdetails.php?id='.$id.'" style="text-decoration:none;color:black">'.$name.'</a></td>';
      ...
      <section class="box">
          ...
          <form action="studentname.php" method="POST" enctype="multipart/form-data" >
